-- Allow accountant to complete vehicle, driver and supplier fields for final dispatch order records.
-- Sale remains blocked from these fields; dispatcher remains blocked from sale/finance fields.
